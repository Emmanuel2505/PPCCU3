    ...
    function fillDataCart(){
        fetch(`${URLSERVER}api/cart/getCart`, {
          ...
          .then(data => {listCart = data;
            ...
            //console.log(listCart, " ", listProduct.length," ",listCart.length );
            if(listProduct.length <= listCart.length){
                                            ...
                                            listProduct.map(product => {
                                                ...
                                                return(
                                                    <tr className="odd:bg-[#D0D0D0] h-28 m-4">
                                                        <td className="w-28"><div className={`w-[50%] h-[50%]  m-2 ${classCenter}`}><img  src={product.image} alt={product.name}/></div></td>
